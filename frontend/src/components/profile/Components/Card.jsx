      ...
      <div className="bg-white/50 backdrop-blur-md lg:rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <div className="relative px-6">
          ...
          <div className="pt-20 pb-6 pl-5 lg:pl-44">
            <h1 className="text-3xl font-extrabold text-gray-900">{provider.fullname}</h1>
            <p className="text-base text-gray-600 mt-1">{provider.city}, {provider.state}</p>
        ...
        <div className="border-t border-gray-300 px-6 py-5 grid grid-cols-1 md:grid-cols-1 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-700 text-base leading-relaxed">{provider.description}</p>
          </div>
          ...
          <div className="space-y-4 grid md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-gray-700 text-base">
                {provider.experience} years experience<br/>
                <span className="text-green-600 font-semibold text-lg">₹{provider.price} per hour</span>
              </p>
            </div>

            <div>
              <h2 className="text-lg font-semibold mb-1">Contact & Availability</h2>
              <p className="text-gray-700 text-base">
                📞 {provider.contactnumber} <br />
                ⏰ {provider.time}
              </p>
            </div>
          </div>
