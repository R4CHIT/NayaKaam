...
const AccountDelete = () => {
  ...
  const handleDeleteAccount = async (passwordInput) => {
    try {
      const status = await deleteAccount(passwordInput);
          ...
          <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-grow">
                <h3 className="text-lg font-medium text-slate-800 mb-2">Logout</h3>
          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-slate-800">
                {user.auth_type === "system" ? "Confirm Account Deletion" : "Are you sure?"}
              </h3>
            </div>

            <p className="text-slate-600 mb-6">
              {user?.auth_type === "system"
                ? "Enter your password to permanently delete your account. This action cannot be undone."
                : "Are you absolutely sure you want to delete your Google-linked account? This action is permanent and cannot be undone."}
            </p>
